...
public class ExecBlockSQLExec extends ExecBlock {
	...
	public ExecBlockSQLExec(String name, ExecIF parent, MainContext mCtx) {
	...
	public ExecIF duplicate(ExecIF parent) throws DBTException, DataException {
		...
		ExecBlockSQLExec exec =
				new ExecBlockSQLExec(this.name, parent, this.mCtx);
